...
function About() {
  return (
    <div className='container fs-4 mt-4 text-warning'>
      <h2 className='text-center text-light'>Introduction</h2>
      <p>Hello, NCAA Squares is a game designed to be played during March Madness.  The game consists of a board 10x10, where all the players select squares for themselves, and as individual basketball games are finished the final score is used to determine  a winner</p>
